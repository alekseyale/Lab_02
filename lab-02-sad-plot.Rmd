...
author: "Group Members: Aleksey, Tymek, Fedor and Danny"
date: "`r Sys.Date()`"
...
Yes it was correct, rows number is 55
...
*Data not visible, x-axis labels are illegible due to overlapping*

```{r lineplot-1}
staff_long %>%
  ggplot(aes(x = year, y = per_of_hires, color = faculty_type, group = faculty_type)) +
  geom_line()
```
...
staff_long %>%
  ...
  geom_line() + 
  labs(
     title = "Percentage Changes of Faculty type from 1975 to 2011",
